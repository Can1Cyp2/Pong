class Player {
    ...
    checkSides(){   // check if the player is at the max or lowest height and prevent them from moving past
...
class Ball {
    ...
    getRandomVelocity(){   // Moves ball in random direction on start
...
function collision() { // Checks if the ball hit a wall
    // Player 1:
...
function ai(){
    ...
    player2.y = ball.y - playerSizeH / 2
}
